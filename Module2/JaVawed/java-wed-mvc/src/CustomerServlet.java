...
public class CustomerServlet extends HttpServlet {
    ...
    private void seachCustomer(HttpServletRequest request, HttpServletResponse response) {
        String name = request.getParameter("name");
        List<Customer> customer = this.customerService.seach(name);
        ...
        if (customer==null){
            ...
            dispatcher = request.getRequestDispatcher("customer/seach.jsp");
        }
        try {
